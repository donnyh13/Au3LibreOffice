...
Func Example()
	...
	If @error Then _ERROR("Failed to retrieve Text Table cell current vertical orientation. Error:" & @error & " Extended:" & @extended)
	...
	If @error Then _ERROR("Failed to set Text Table cell vertical orientation. Error:" & @error & " Extended:" & @extended)
