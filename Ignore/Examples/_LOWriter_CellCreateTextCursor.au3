...
Func Example()
	...
	If @error Then _ERROR("Failed to create a Text Cursor in Text Table cell. Error:" & @error & " Extended:" & @extended)

	; Move the text cursor to the end of the text.
	_LOWriter_CursorMove($oTextCursor, $LOW_TEXTCUR_GOTO_END)
	If @error Then _ERROR("Failed to move Text Cursor. Error:" & @error & " Extended:" & @extended)
