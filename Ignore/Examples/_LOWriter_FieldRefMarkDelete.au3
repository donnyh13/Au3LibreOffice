...
Func Example()
	...
	If @error Then _ERROR("Failed to insert a Reference Mark. Error:" & @error & " Extended:" & @extended)
	...
	MsgBox($MB_OK, "", "Press Ok to delete Reference Mark 2")

	; Delete Ref. 2
	_LOWriter_FieldRefMarkDelete($oDoc, "Ref. 2")
	If @error Then _ERROR("Failed to delete a Reference Mark. Error:" & @error & " Extended:" & @extended)

	; Retrieve an Array of Reference Mark Names.
	$asRefs = _LOWriter_FieldRefMarkList($oDoc)
	If @error Then _ERROR("Failed to retrieve an Array of Reference Marks. Error:" & @error & " Extended:" & @extended)
