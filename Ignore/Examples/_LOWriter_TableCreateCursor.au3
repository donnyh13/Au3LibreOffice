...
Func Example()
	...
	If @error Then _ERROR("Failed to move Text Table Cursor. Error:" & @error & " Extended:" & @extended)

	; Merge the Cells selected by this Table Cursor.
	_LOWriter_TableCursor($oTableCursor, Null, False, True)
	If @error Then _ERROR("Failed to merge cells selected by Text Table Cursor. Error:" & @error & " Extended:" & @extended)
