...
Func Example()
	...
	; Set the paragraph at the current cursor's location Shadow to 1/4" wide, Color to $LOW_COLOR_PURPLE, Transparent to false, and location to
	; $LOW_SHADOW_TOP_LEFT
	_LOWriter_DirFrmtParShadow($oViewCursor, $iMicrometers, $LOW_COLOR_PURPLE, False, $LOW_SHADOW_TOP_LEFT)
