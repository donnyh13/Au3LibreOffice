...
Func Example()
	...
	If @error Then _ERROR("Failed to create a Date/Time Format Key. Error:" & @error & " Extended:" & @extended)

	; Check if the new key exists.
	$bExists = _LOWriter_DateFormatKeyExists($oDoc, $iFormatKey)
	If @error Then _ERROR("Failed to search for a Date/Time Format Key. Error:" & @error & " Extended:" & @extended)
	...
	If @error Then _ERROR("Failed to delete a Date/Time Format Key. Error:" & @error & " Extended:" & @extended)

	; Check if the new key exists now.
	$bExists = _LOWriter_DateFormatKeyExists($oDoc, $iFormatKey)
	If @error Then _ERROR("Failed to search for a Date/Time Format Key. Error:" & @error & " Extended:" & @extended)
