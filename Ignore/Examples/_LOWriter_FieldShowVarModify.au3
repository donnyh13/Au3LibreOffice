...
Func Example()
	...
	If @error Then _ERROR("Failed to retrieve Number Format Key. Error:" & @error & " Extended:" & @extended)
	...
	If @error Then _ERROR("Failed to modify a text field. Error:" & @error & " Extended:" & @extended)
