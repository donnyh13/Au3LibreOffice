...
Func Example()
	...
	If @error Then _ERROR("Failed to retrieve array of Paragraph Object sections. Error:" & @error & " Extended:" & @extended)
	...
	If @error Then _ERROR("Failed to direct format Paragraph Object. Error:" & @error & " Extended:" & @extended)
