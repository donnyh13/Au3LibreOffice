...
Func Example()
	...
	If @error Then _ERROR("Failed to query for Frame Style. Error:" & @error & " Extended:" & @extended)
	...
	If @error Then _ERROR("Failed to delete a Frame Style. Error:" & @error & " Extended:" & @extended)
