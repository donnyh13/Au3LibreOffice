...
Func Example()
	...
	;Retrieve middle left and middle 2nd in column Table Cell Objects, Table Rows and columns are 0 based, so left hand column is 0, 2nd row down is 1.
	$oCell = _LOWriter_TableGetCellByPosition($oTable, 0, 1, 1, 1)
