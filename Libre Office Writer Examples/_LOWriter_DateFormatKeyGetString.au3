...
Func Example()
	...
	MsgBox($MB_OK, "", "I created a new DateTime format key, it's key number is: " & $iFormatKey & " and it looks like this: " & _
			_LOWriter_DateFormatKeyGetString($oDoc, $iFormatKey))
