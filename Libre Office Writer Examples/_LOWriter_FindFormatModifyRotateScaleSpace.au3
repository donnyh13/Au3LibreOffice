...
Func Example()
	...
	;Set the selected text to Auto Kerning = True
	...
	;Create a Find Format Search Array for auto Kerning
	_LOWriter_FindFormatModifyRotateScaleSpace($atFindFormat, Null, Null, True)
