...
Func _LOImpress_ShapeAreaColor(ByRef $oShape, $iColor = Null)
	...
	$vReturn = __LOImpress_ShapeAreaColor($oShape, $iColor)
...
;                  --Input Errors--
;                  @Error 1 @Extended 1 Return 0 = $oShape not an Object.
;                  @Error 1 @Extended 2 Return 0 = $oShape does not support Character properties.
...
;                  Failure: 0 and sets the @Error and @Extended flags to non-zero.
;                  --Input Errors--
;                  @Error 1 @Extended 1 Return 0 = $oShape an Object.
...
; Parameters ....: $oImage              - [in/out] an object. A Image object returned by a previous _LOImpress_ShapeImageInsert, or _LOImpress_ShapesGetList function.
;                  $sText               - [optional] a string value. Default is Null. Enter alternative text to display when the image isn't available.
;                  $sAltText            - [optional] a string value. Default is Null. Detailed alternative text of the Image.
...
;                  @Error 1 @Extended 2 Return 0 = Shape called in $oImage not an Image shape.
...
;                  @Error 1 @Extended 1 Return 0 = $oImage not an Object.
;                  @Error 1 @Extended 2 Return 0 = Shape called in $oImage not an Image shape.
;                  @Error 1 @Extended 3 Return 0 = $bKeepScale not a Boolean.
...
; Parameters ....: $oSlide              - [in/out] an object. A Slide object returned by a previous _LOImpress_SlideAdd, _LOImpress_SlideGetObjByIndex, _LOImpress_SlideGetObjByName, or _LOImpress_SlideCopy function.
;                  $sURL                - a string value. The file path to the image to insert.
; Return values .: Success: Object.
;                  Failure: 0 and sets the @Error and @Extended flags to non-zero.
;                  --Input Errors--
;                  @Error 1 @Extended 1 Return 0 = $oSlide not an Object.
;                  @Error 1 @Extended 2 Return 0 = $sImage not a String.
;                  @Error 1 @Extended 3 Return 0 = Image called in $sImage doesn't exist at given path.
;                  --Initialization Errors--
;                  @Error 2 @Extended 1 Return 0 = Failure creating "com.sun.star.drawing.GraphicObjectShape" Object.
;                  --Processing Errors--
;                  @Error 3 @Extended 1 Return 0 = Error converting Image Path to LibreOffice URL.
;                  @Error 3 @Extended 2 Return 0 = Error retrieving Document Object.
;                  @Error 3 @Extended 3 Return 0 = Error retrieving Bitmap size.
;                  @Error 3 @Extended 4 Return 0 = Error retrieving image's size structure.
;                  @Error 3 @Extended 5 Return 0 = Error calculating image's ratio.
;                  @Error 3 @Extended 6 Return 0 = Error calculating Slide's ratio.
;                  @Error 3 @Extended 7 Return 0 = Error retrieving image's Position structure.
;                  --Success--
...
;                  $bFlipHori           - [optional] a boolean value. Default is Null. If True, the image is flipped horizontally.
; Return values .: Success: 1 or Array.
;                  Failure: 0 and sets the @Error and @Extended flags to non-zero.
;                  --Input Errors--
;                  @Error 1 @Extended 1 Return 0 = $oImage not an Object.
;                  @Error 1 @Extended 2 Return 0 = Shape called in $oImage not an Image shape.
;                  @Error 1 @Extended 3 Return 0 = $bFlipVert not a Boolean.
;                  @Error 1 @Extended 4 Return 0 = $bFlipHori not a Boolean.
;                  --Property Setting Errors--
;                  @Error 4 @Extended ? Return 0 = Some settings were not successfully set. Use BitAND to test @Extended for following values:
...
;                  @Error 1 @Extended 1 Return 0 = $oImage not an Object.
;                  @Error 1 @Extended 2 Return 0 = Shape called in $oImage not an Image shape.
;                  @Error 1 @Extended 3 Return 0 = $sNewImage not a string.
;                  @Error 1 @Extended 4 Return 0 = File called in $sNewImage doesn't exist.
;                  --Processing Errors--
...
;                  @Error 3 @Extended 2 Return 0 = Failed to retrieve Parent Slide Object.
;                  --Property Setting Errors--
;                  @Error 4 @Extended ? Return 0 = Some settings were not successfully set. Use BitAND to test @Extended for the following values:
...
; Parameters ....: $oPresStyle          - [in/out] an object. A Presentation Style object returned by a previous _LOImpress_ShapePresStyleGetObjByName function.
;                  $iColor              - [optional] an integer value (-1-16777215). Default is Null. The Fill color, as a RGB Color Integer. Can be a custom value, or one of the constants, $LO_COLOR_* as defined in LibreOffice_Constants.au3. Call with $LO_COLOR_OFF(-1) for "None".
; Return values .: Success: 1 or Integer.
;                  Failure: 0 and sets the @Error and @Extended flags to non-zero.
;                  --Input Errors--
...
Func _LOImpress_ShapePresStyleAreaColor(ByRef $oPresStyle, $iColor = Null)
	...
	$vReturn = __LOImpress_ShapeAreaColor($oPresStyle, $iColor)
...
;                  $oPresStyle          - [in/out] an object. A Presentation Style object returned by a previous _LOImpress_ShapePresStyleGetObjByName function.
;                  $sGradientName       - [optional] a string value. Default is Null. A Preset Gradient Name. See remarks. See constants, $LOI_GRAD_NAME_* as defined in LibreOfficeImpress_Constants.au3.
;                  $iType               - [optional] an integer value (-1-5). Default is Null. The gradient type to apply. See Constants, $LOI_GRAD_TYPE_* as defined in LibreOfficeImpress_Constants.au3.
;                  $iIncrement          - [optional] an integer value (0, 3-256). Default is Null. The number of steps of color change. 0 = Automatic.
;                  $iXCenter            - [optional] an integer value (0-100). Default is Null. The horizontal offset for the gradient, where 0% corresponds to the current horizontal location of the endpoint color in the gradient. The endpoint color is the color that is selected in the "To Color" setting. Set in percentage. $iType must be other than "Linear", or "Axial".
...
; Parameters ....: $oPresStyleStyle     - [in/out] an object. A Presentation Style object returned by a previous _LOImpress_ShapePresStyleGetObjByName function.
;                  $iTransparency       - [optional] an integer value (0-100). Default is Null. The color transparency. 0% is fully opaque and 100% is fully transparent.
; Return values .: Success: Integer.
;                  Failure: 0 and sets the @Error and @Extended flags to non-zero.
;                  --Input Errors--
;                  @Error 1 @Extended 1 Return 0 = $oPresStyleStyle not an Object.
;                  @Error 1 @Extended 2 Return 0 = $iTransparency not an Integer, less than 0 or greater than 100.
;                  --Processing Errors--
;                  @Error 3 @Extended 1 Return 0 = Failed to retrieve current Transparency value.
;                  --Property Setting Errors--
...
;                  Failure: 0 and sets the @Error and @Extended flags to non-zero.
;                  --Input Errors--
;                  @Error 1 @Extended 1 Return 0 = $oPresStyle an Object.
;                  @Error 1 @Extended 2 Return 0 = $iUnderLineStyle not an Integer, less than 0 or greater than 18. See constants, $LOI_CHAR_UNDERLINE_* as defined in LibreOfficeImpress_Constants.au3.
;                  @Error 1 @Extended 3 Return 0 = $iULColor not an Integer, less than -1 or greater than 16777215.
;                  @Error 1 @Extended 4 Return 0 = $bWordOnly not a Boolean.
;                  --Property Setting Errors--
...
; Parameters ....: $oDoc                - [in/out] an object. A Document object returned by a previous _LOImpress_DocOpen, _LOImpress_DocConnect, or _LOImpress_DocCreate function.
;                  $sPresStyle          - a string value. The Presentation Style name to retrieve the Object for.
; Return values .: Success: Object
;                  Failure: 0 and sets the @Error and @Extended flags to non-zero.
;                  --Input Errors--
;                  @Error 1 @Extended 1 Return 0 = $oDoc not an Object.
;                  @Error 1 @Extended 2 Return 0 = $sPresStyle not a String.
;                  @Error 1 @Extended 3 Return 0 = Presentation Style called in $sPresStyle not found in Document.
;                  --Processing Errors--
;                  @Error 3 @Extended 1 Return 0 = Error retrieving Presentation Style Object.
;                  --Success--
...
;                  $iNumFormat          - [optional] an integer value (0-71). Default is Null. The numbering scheme for the selected levels. See Constants, $LOI_NUM_FRMT_* as defined in LibreOfficeImpress_Constants.au3.
;                  $iStartAt            - [optional] an integer value. Default is Null. A new starting number for the current level
;                  $iColor              - [optional] an integer value (-1-16777215). Default is Null. The color of the numbering symbol, as a RGB Color Integer. Can be a custom value, or one of the constants, $LO_COLOR_* as defined in LibreOffice_Constants.au3.
;                  $iRelSize            - [optional] an integer value (25-400). Default is Null. The percentage to resize the numbering symbol, relative to the paragraph font size.
...
;                  $iCharDecimal        - [optional] an integer value. Default is Null. The ASCII Decimal character code value (See ASC function) of the desired character. Note: $iNumFormat must be set to $LOI_NUM_FRMT_CHAR_SPECIAL(6) before these can be set.
; Return values .: Success: 1 or Array.
;                  Failure: 0 and sets the @Error and @Extended flags to non-zero.
;                  --Input Errors--
;                  @Error 1 @Extended 1 Return 0 = $oDoc not an Object.
;                  @Error 1 @Extended 2 Return 0 = $oPresStyle not an Object.
;                  @Error 1 @Extended 3 Return 0 = $oPresStyle not a Presentation Style Object.
;                  @Error 1 @Extended 4 Return 0 = $iLevel not between 0 - 10.
;                  @Error 1 @Extended 5 Return 0 = $iNumFormat not an Integer, less than 0 or greater than 71. See Constants, $LOI_NUM_FRMT_* as defined in LibreOfficeImpress_Constants.au3.
...
;                  @Error 1 @Extended 8 Return 0 = $iRelSize not an Integer, less than 25 or greater than 400.
;                  @Error 1 @Extended 9 Return 0 = $sSepBefore not a string.
;                  @Error 1 @Extended 10 Return 0 = $sSepAfter not a string.
;                  @Error 1 @Extended 11 Return 0 = $iCharDecimal not an Integer.
;                  @Error 1 @Extended 12 Return 0 = $iCharDecimal was called and Number Format not set to $LOI_NUM_FRMT_CHAR_SPECIAL.
;                  --Initialization Errors--
...
;                  --Input Errors--
;                  @Error 1 @Extended 1 Return 0 = $oDoc not an Object.
;                  @Error 1 @Extended 2 Return 0 = $bAppliedOnly not a Boolean.
;                  @Error 1 @Extended 3 Return 0 = $bDisplayName not a Boolean.
;                  --Processing Errors--
;                  @Error 3 @Extended 1 Return 0 = Failed to retrieve Array of Presentation Style names.
;                  --Success--
...
; Parameters ....: $oShapeStyle         - [in/out] an object. A Shape Style object returned by a previous _LOImpress_ShapeStyleCreate, or _LOImpress_ShapeStyleGetObjByName function.
;                  $iColor              - [optional] an integer value (-1-16777215). Default is Null. The Fill color, as a RGB Color Integer. Can be a custom value, or one of the constants, $LO_COLOR_* as defined in LibreOffice_Constants.au3. Call with $LO_COLOR_OFF(-1) for "None".
; Return values .: Success: 1 or Integer.
;                  Failure: 0 and sets the @Error and @Extended flags to non-zero.
;                  --Input Errors--
...
Func _LOImpress_ShapeStyleAreaColor(ByRef $oShapeStyle, $iColor = Null)
	...
	$vReturn = __LOImpress_ShapeAreaColor($oShapeStyle, $iColor)
...
; Parameters ....: $oDoc                - [in/out] an object. A Document object returned by a previous _LOImpress_DocOpen, _LOImpress_DocConnect, or _LOImpress_DocCreate function.
;                  $oShapeStyle         - [in/out] an object. A Shape Style object returned by a previous _LOImpress_ShapeStyleCreate, or _LOImpress_ShapeStyleGetObjByName function.
;                  $sGradientName       - [optional] a string value. Default is Null. A Preset Gradient Name. See remarks. See constants, $LOI_GRAD_NAME_* as defined in LibreOfficeImpress_Constants.au3.
;                  $iType               - [optional] an integer value (-1-5). Default is Null. The gradient type to apply. See Constants, $LOI_GRAD_TYPE_* as defined in LibreOfficeImpress_Constants.au3.
;                  $iIncrement          - [optional] an integer value (0, 3-256). Default is Null. The number of steps of color change. 0 = Automatic.
;                  $iXCenter            - [optional] an integer value (0-100). Default is Null. The horizontal offset for the gradient, where 0% corresponds to the current horizontal location of the endpoint color in the gradient. The endpoint color is the color that is selected in the "To Color" setting. Set in percentage. $iType must be other than "Linear", or "Axial".
...
;                  Failure: 0 and sets the @Error and @Extended flags to non-zero.
;                  --Input Errors--
;                  @Error 1 @Extended 1 Return 0 = $oShapeStyle an Object.
;                  @Error 1 @Extended 2 Return 0 = $iUnderLineStyle not an Integer, less than 0 or greater than 18. See constants, $LOI_CHAR_UNDERLINE_* as defined in LibreOfficeImpress_Constants.au3.
;                  @Error 1 @Extended 3 Return 0 = $iULColor not an Integer, less than -1 or greater than 16777215.
;                  @Error 1 @Extended 4 Return 0 = $bWordOnly not a Boolean.
;                  --Property Setting Errors--
...
;                  @Error 1 @Extended 3 Return 0 = $iHoriBeg not an Integer, less than 0 or greater than 10,008.
;                  @Error 1 @Extended 4 Return 0 = $iHoriEnd not an Integer, less than 0 or greater than 10,008.
;                  @Error 1 @Extended 5 Return 0 = $iVertBeg not an Integer, less than 0 or greater than 10,008.
;                  @Error 1 @Extended 6 Return 0 = $iVertEnd not an Integer, less than 0 or greater than 10,008.
;                  --Property Setting Errors--
;                  @Error 4 @Extended ? Return 0 = Some settings were not successfully set. Use BitAND to test @Extended for following values:
;                  |                               1 = Error setting $iType
...
; Parameters ....: $oDoc                - [in/out] an object. A Document object returned by a previous _LOImpress_DocOpen, _LOImpress_DocConnect, or _LOImpress_DocCreate function.
;                  $sShapeStyle         - a string value. The Name of the new Drawing/Shape Style to Create.
; Return values .: Success: Object
;                  Failure: 0 and sets the @Error and @Extended flags to non-zero.
;                  --Input Errors--
;                  @Error 1 @Extended 1 Return 0 = $oDoc not an Object.
;                  @Error 1 @Extended 2 Return 0 = $sShapeStyle not a String.
;                  @Error 1 @Extended 3 Return 0 = Shape Style name called in $sShapeStyle already exists in document.
;                  --Initialization Errors--
;                  @Error 2 @Extended 1 Return 0 = Error Creating new Shape Style Object.
;                  --Processing Errors--
;                  @Error 3 @Extended 1 Return 0 = Error Retrieving "graphics" style family Object.
;                  @Error 3 @Extended 2 Return 0 = Error creating new Shape Style by name.
;                  @Error 3 @Extended 3 Return 0 = Error Retrieving Created Shape Style Object.
;                  --Success--
...
; Parameters ....: $oDoc                - [in/out] an object. A Document object returned by a previous _LOImpress_DocOpen, _LOImpress_DocConnect, or _LOImpress_DocCreate function.
;                  $oShape              - [in/out] an object. A Shape object returned by a previous _LOImpress_DrawShapeInsert, or _LOImpress_ShapesGetList function. See remarks.
;                  $sShapeStyle         - [optional] a string value. Default is Null. The Drawing/Shape Style name to set the Shape to. See remarks.
; Return values .: Success: 1 or String.
;                  Failure: 0 and sets the @Error and @Extended flags to non-zero.
;                  --Input Errors--
;                  @Error 1 @Extended 1 Return 0 = $oDoc not an Object.
;                  @Error 1 @Extended 2 Return 0 = $oShape not an Object.
;                  @Error 1 @Extended 3 Return 0 = $oShape does not support Shape Service.
;                  @Error 1 @Extended 4 Return 0 = $sShapeStyle not a String.
;                  @Error 1 @Extended 5 Return 0 = Drawing/Shape Style called in $sShapeStyle not found in Document.
;                  @Error 1 @Extended 6 Return 0 = Can't set Drawing/Shape Style for Title/Subtitle/Outline text box, or other non-user created shapes.
;                  --Processing Errors--
;                  @Error 3 @Extended 1 Return 0 = Failed to retrieve current Drawing/Shape Style name.
;                  --Property Setting Errors--
;                  @Error 4 @Extended ? Return 0 = Some settings were not successfully set. Use BitAND to test @Extended for following values:
...
; Parameters ....: $oDoc                - [in/out] an object. A Document object returned by a previous _LOImpress_DocOpen, _LOImpress_DocConnect, or _LOImpress_DocCreate function.
;                  $oShapeStyle         - [in/out] an object. A Drawing/Shape Style object returned by a previous _LOImpress_ShapeStyleCreate, or _LOImpress_ShapeStyleGetObjByName function. Must be a User-Created Style, not a built-in Style native to LibreOffice.
;                  $bForceDelete        - [optional] a boolean value. Default is False. If True, Drawing/Shape style will be deleted regardless of whether it is in use or not.
;                  $sReplacementStyle   - [optional] a string value. Default is "standard". The Drawing/Shape style to use instead of the one being deleted if the Drawing/Shape style being deleted is applied to text in the document.
; Return values .: Success: 1
;                  Failure: 0 and sets the @Error and @Extended flags to non-zero.
;                  --Input Errors--
;                  @Error 1 @Extended 1 Return 0 = $oDoc not an Object.
;                  @Error 1 @Extended 2 Return 0 = $oShapeStyle not an Object.
;                  @Error 1 @Extended 3 Return 0 = $oShapeStyle not a Drawing/Shape style Object.
;                  @Error 1 @Extended 4 Return 0 = $bForceDelete not a Boolean.
;                  @Error 1 @Extended 5 Return 0 = $sReplacementStyle not a String.
;                  @Error 1 @Extended 6 Return 0 = Drawing/Shape Style called in $sReplacementStyle doesn't exist in Document.
;                  --Processing Errors--
;                  @Error 3 @Extended 1 Return 0 = Error retrieving "graphics" style family Object.
;                  @Error 3 @Extended 2 Return 0 = Error retrieving Shape Style Name.
;                  @Error 3 @Extended 3 Return 0 = $oShapeStyle is not a User-Created Shape Style and cannot be deleted.
;                  @Error 3 @Extended 4 Return 0 = $oShapeStyle is in use and $bForceDelete is False.
;                  @Error 3 @Extended 5 Return 0 = $oShapeStyle still exists after deletion attempt.
;                  --Success--
...
; Parameters ....: $oDoc                - [in/out] an object. A Document object returned by a previous _LOImpress_DocOpen, _LOImpress_DocConnect, or _LOImpress_DocCreate function.
;                  $sShapeStyle         - a string value. The Drawing/Shape Style Name to search for.
; Return values .: Success: Boolean
;                  Failure: 0 and sets the @Error and @Extended flags to non-zero.
;                  --Input Errors--
;                  @Error 1 @Extended 1 Return 0 = $oDoc not an Object.
...
; Parameters ....: $oDoc                - [in/out] an object. A Document object returned by a previous _LOImpress_DocOpen, _LOImpress_DocConnect, or _LOImpress_DocCreate function.
;                  $sShapeStyle         - a string value. The Drawing/Shape Style name to retrieve the Object for.
; Return values .: Success: Object
;                  Failure: 0 and sets the @Error and @Extended flags to non-zero.
;                  --Input Errors--
;                  @Error 1 @Extended 1 Return 0 = $oDoc not an Object.
;                  @Error 1 @Extended 2 Return 0 = $sShapeStyle not a String.
;                  @Error 1 @Extended 3 Return 0 = Drawing/Shape Style called in $sShapeStyle not found in Document.
;                  --Processing Errors--
;                  @Error 3 @Extended 1 Return 0 = Error retrieving Drawing/Shape Style Object.
;                  --Success--
...
; Parameters ....: $oDoc                - [in/out] an object. A Document object returned by a previous _LOImpress_DocOpen, _LOImpress_DocConnect, or _LOImpress_DocCreate function.
;                  $oShapeStyle         - [in/out] an object. A Shape Style object returned by a previous _LOImpress_ShapeStyleCreate, or _LOImpress_ShapeStyleGetObjByName function.
;                  $sNewShapeStyleName  - [optional] a string value. Default is Null. The new name to set the Shape style called in $oShapeStyle to.
;                  $sParentStyle        - [optional] a string value. Default is Null. Set an existing Shape style (or an Empty String ("") = - None -) to apply its settings to the current style. Use the other settings to modify the inherited style settings.
...
; Parameters ....: $oDoc                - [in/out] an object. A Document object returned by a previous _LOImpress_DocOpen, _LOImpress_DocConnect, or _LOImpress_DocCreate function.
;                  $bUserOnly           - [optional] a boolean value. Default is False. If True, only User-Created Drawing/Shape Styles are returned.
;                  $bAppliedOnly        - [optional] a boolean value. Default is False. If True, only Applied Drawing/Shape Styles are returned.
;                  $bDisplayName        - [optional] a boolean value. Default is False. If True, the style name displayed in the UI (Display Name), instead of the programmatic style name, is returned. See remarks.
; Return values .: Success: Array
;                  Failure: 0 and sets the @Error and @Extended flags to non-zero.
;                  --Input Errors--
...
;                  --Processing Errors--
;                  @Error 3 @Extended 1 Return 0 = Failed to retrieve Array of Drawing/Shape Style names.
;                  --Success--
...
; Parameters ....: $oSlide              - [in/out] an object. A Slide object returned by a previous _LOImpress_SlideAdd, _LOImpress_SlideGetObjByIndex, _LOImpress_SlideGetObjByName, or _LOImpress_SlideCopy function.
;                  $iWidth              - an integer value. The Table's Width in Hundredths of a Millimeter (HMM).
;                  $iHeight             - an integer value. The Table's Height in Hundredths of a Millimeter (HMM).
;                  $iRows               - [optional] an integer value (1-75). Default is 2. The number of Rows.
;                  $iColumns            - [optional] an integer value (1-75). Default is 2. The number of Columns.
;                  $iX                  - [optional] an integer value. Default is 0. The X position from the top-left of the page, in Hundredths of a Millimeter (HMM).
;                  $iY                  - [optional] an integer value. Default is 0. The Y position from the top-left of the page, in Hundredths of a Millimeter (HMM).
; Return values .: Success: Object
;                  Failure: 0 and sets the @Error and @Extended flags to non-zero.
;                  --Input Errors--
;                  @Error 1 @Extended 1 Return 0 = $oSlide not an Object.
...
;                  @Error 1 @Extended 4 Return 0 = $iRows not an Integer, less than 1 or greater than 75.
;                  @Error 1 @Extended 5 Return 0 = $iColumns not an Integer, less than 1 or greater than 75.
;                  @Error 1 @Extended 6 Return 0 = $iX not an Integer.
;                  @Error 1 @Extended 7 Return 0 = $iY not an Integer.
;                  --Initialization Errors--
;                  @Error 2 @Extended 1 Return 0 = Failed to create a "com.sun.star.drawing.TableShape" Object.
;                  --Processing Errors--
;                  @Error 3 @Extended 1 Return 0 = Failed to retrieve parent Document Object.
;                  @Error 3 @Extended 2 Return 0 = Failed to retrieve Default Table Style.
;                  @Error 3 @Extended 3 Return 0 = Failed to retrieve Position Structure.
;                  @Error 3 @Extended 4 Return 0 = Failed to retrieve Size Structure.
;                  --Success--
...
; Parameters ....: $oSlide              - [in/out] an object. A Slide object returned by a previous _LOImpress_SlideAdd, _LOImpress_SlideGetObjByIndex, _LOImpress_SlideGetObjByName, or _LOImpress_SlideCopy function.
;                  $iTextBoxType        - an integer value (0-3). The type of Text Box to create. See Constants, $LOI_SHAPE_TEXTBOX_TYPE_* as defined in LibreOfficeImpress_Constants.au3.
;                  $iWidth              - an integer value. The Text Box's Width in Hundredths of a Millimeter (HMM).
;                  $iHeight             - an integer value. The Text Box's Height in Hundredths of a Millimeter (HMM).
;                  $iX                  - [optional] an integer value. Default is 0. The X position from the top-left of the page, in Hundredths of a Millimeter (HMM).
;                  $iY                  - [optional] an integer value. Default is 0. The Y position from the top-left of the page, in Hundredths of a Millimeter (HMM).
; Return values .: Success: Object
;                  Failure: 0 and sets the @Error and @Extended flags to non-zero.
;                  --Input Errors--
;                  @Error 1 @Extended 1 Return 0 = $oSlide not an Object.
;                  @Error 1 @Extended 2 Return 0 = $iTextBoxType not an Integer, less than 0 or greater than 3. See Constants, $LOI_SHAPE_TEXTBOX_TYPE_* as defined in LibreOfficeImpress_Constants.au3.
...
;                  --Initialization Errors--
;                  @Error 2 @Extended 1 Return 0 = Failed to create the requested Text Box type.
;                  --Processing Errors--
;                  @Error 3 @Extended 1 Return 0 = Failed to retrieve parent Document Object.
;                  @Error 3 @Extended 2 Return 0 = Failed to retrieve Position Structure.
;                  @Error 3 @Extended 3 Return 0 = Failed to retrieve Size Structure.
;                  --Success--
