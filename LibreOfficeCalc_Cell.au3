...
;                  To skip parameters: Pass the Null keyword to any optional parameter.
;                  $iAll returns an Integer value if all (Top, Bottom, Left, Right) padding values are equal, else Null is returned.
; Related .......: _LOCalc_CellStyleBorderColor, _LOCalc_CellStyleBorderStyle, _LOCalc_CellStyleBorderWidth, _LOCalc_CellBorderPadding
; Link ..........:
; Example .......: Yes
; ===============================================================================================================================
...
Func _LOCalc_CellStyleDelete(ByRef $oDoc, ByRef $oCellStyle, $bForceDelete = False, $sReplacementStyle = "Default")
	...
	If $oCellStyles.hasByName($sCellStyle) Then Return SetError($__LO_STATUS_PROCESSING_ERROR, 5, 0)
...
; Example .......: Yes
; ===============================================================================================================================
Func _LOCalc_CellStyleGetObjByName(ByRef $oDoc, $sCellStyle)
	Local $oCOM_ErrorHandler = ObjEvent("AutoIt.Error", __LOCalc_InternalComErrorHandler)
	#forceref $oCOM_ErrorHandler
	...
	Return SetError($__LO_STATUS_SUCCESS, 0, $oCellStyle)
EndFunc   ;==>_LOCalc_CellStyleGetObjByName
