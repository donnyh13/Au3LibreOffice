...
Func Example()
	...
	; Insert some Text
	_LOImpress_CursorInsertString($oTextCursor, "The current time is: ")
	...
	_LOImpress_FieldDateTimeInsert($oDoc, $oTextCursor, False, False, Null, $LOI_FIELD_TIME_FMT_12H_HMS_AMPM)
	...
	; Insert some Text
	_LOImpress_CursorInsertString($oTextCursor, @LF & "This example was prepared on the date of: ")
	If @error Then _ERROR($oDoc, "Failed to insert some text. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)
