...
Func Example()
	...
	_LOImpress_ShapeStyleCharEffect($oStyle, Null, $LOI_CHAR_RELIEF_EMBOSSED)
	...
	$avSettings = _LOImpress_ShapeStyleCharEffect($oStyle)
	...
	_LOImpress_ShapeStyleCharEffect($oStyle, $LOI_CHAR_CASEMAP_SM_CAPS, $LOI_CHAR_RELIEF_NONE, True, True)
	If @error Then _ERROR($oDoc, "Failed to set the Style's settings. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)
