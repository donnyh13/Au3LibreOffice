...
Func Example()
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "The Document contains the following Reports:" & @CRLF & $sReports & @CRLF & _
			"Press ok to rename ""rptAutoIt_Report2"" in Folder1.")

	; Rename "rptAutoIt_Report2" to rptTestReport.
	_LOBase_ReportRename($oDoc, "Folder1/rptAutoIt_Report2", "rptTestReport")
	If @error Then Return _ERROR($oDoc, "Failed to rename a Report. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)
