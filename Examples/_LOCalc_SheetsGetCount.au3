...
Func Example()
	...
	If @error Then _ERROR($oDoc, "Failed to Retrieve a count of Sheets. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)

	MsgBox($MB_OK + $MB_TOPMOST, Default, "This Document currently has " & $iSheets & " sheets.")
