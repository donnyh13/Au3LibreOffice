...
Func Example()
	...
	$oControl = _LOBase_ReportConInsert($oSection, $LOB_REP_CON_TYPE_LABEL, 10500, 500, 4500, 2000)
	...
	_LOBase_ReportConLabelGeneral($oControl, "Renamed_AutoIt_Control", "An_AutoIt_Label", 'rpt:COUNT(1;1)=VALUE("2")', True, True, $LO_COLOR_GRAY, $mFont, $LOB_PAR_TXT_ALIGN_HORI_CENTER, $LOB_ALIGN_VERT_BOTTOM)
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "The Control's current settings are: " & @CRLF & _
			...
			"The Vertical Alignment is (See UDF Constants): " & $avControl[8])
