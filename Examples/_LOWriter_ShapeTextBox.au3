...
Func Example()
	...
	If @error Then _ERROR($oDoc, "Failed to activate Shape's TextBox and fill it with text. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "The Shape's TextBox settings are as follows: " & @CRLF & _
