...
Func Example()
	...
	If @error Then _ERROR("Failed to retrieve an array of Dependent fields. Error:" & @error & " Extended:" & @extended)
	...
	If @error Then _ERROR("Failed to delete a Dependent field. Error:" & @error & " Extended:" & @extended)
