...
Func Example()
	...
	; Set the Query's SQL command.
	_LOBase_QuerySQLCommand($oQuery, "SELECT ALL ""Col1"" ""First_Col"" FROM ""tblNew_Table"" LIMIT 25")
	If @error Then Return _ERROR($oDoc, "Failed to modify Query SQL. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)
