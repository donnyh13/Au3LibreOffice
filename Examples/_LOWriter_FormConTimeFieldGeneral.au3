...
Func Example()
	...
	$oControl = _LOWriter_FormConInsert($oForm, $LOW_FORM_CON_TYPE_TIME_FIELD, 500, 300, 6000, 2000, "AutoIt_Form_Control")
	...
	$mFont = _LOWriter_FontDescCreate("Times New Roman", $LOW_CHAR_WEIGHT_BOLD, $LOW_CHAR_POSTURE_ITALIC, 18, $LO_COLOR_INDIGO, $LOW_CHAR_UNDERLINE_BOLD, $LO_COLOR_GREEN, $LOW_CHAR_STRIKEOUT_NONE, True, $LOW_CHAR_RELIEF_NONE)
	...
	_LOWriter_FormConTimeFieldGeneral($oControl, "Renamed_AutoIt_Control", $oLabel, Null, True, True, True, False, True, $LOW_FORM_CON_MOUSE_SCROLL_FOCUS, True, 1, $tTimeMin, $tTimeMax, $LOW_FORM_CON_TIME_FRMT_12_LONG, $tTimeDefault, True, True, 50, $mFont, $LOW_ALIGN_HORI_LEFT, $LOW_ALIGN_VERT_MIDDLE, $LO_COLOR_GREEN, $LOW_FORM_CON_BORDER_FLAT, $LO_COLOR_GOLD, False, "Some Additional Information", "This is Help Text", "www.HelpURL.fake")
	...
	$avControl = _LOWriter_FormConTimeFieldGeneral($oControl)
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "The Control's current settings are: " & @CRLF & _
			...
			"This is the minimum Time structure. I'll just check if it is an Object. " & IsObj($avControl[11]) & @CRLF & _
			"This is the maximum Time structure. I'll just check if it is an Object. " & IsObj($avControl[12]) & @CRLF & _
			"What is date format? (See UDF Constants): " & $avControl[13] & @CRLF & _
			"This is the Default Time structure. I'll just check if it is an Object. " & IsObj($avControl[14]) & @CRLF & _
			...
			"The background color is (as a RGB Color Integer): " & $avControl[21] & @CRLF & _
			"The Border Style is (See UDF Constants): " & $avControl[22] & @CRLF & _
			"The Border color is (as a RGB Color Integer): " & $avControl[23] & @CRLF & _
