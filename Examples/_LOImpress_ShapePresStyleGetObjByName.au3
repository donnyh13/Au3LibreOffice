...
Func Example()
	...
	; Retrieve the "Title" Presentation Style.
	...
	; Set the background color to Orange for the style, to show I retrieved it's Object.
	_LOImpress_ShapePresStyleAreaColor($oStyle, $LO_COLOR_ORANGE)
