...
Func Example()
	...
	; Retrieve the current Page Style Footer Fill Style
	$iFillStyle = _LOWriter_PageStyleFooterAreaFillStyle($oPageStyle)
	If @error Then _ERROR($oDoc, "Failed to retrieve the Page style settings. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)

	MsgBox($MB_OK + $MB_TOPMOST, Default, "The Page Style Footer's current Fill Style is: " & $iFillStyle & @CRLF & _
	...
	; Set Page style Footer Background color to $LO_COLOR_LIME
	_LOWriter_PageStyleFooterAreaColor($oPageStyle, $LO_COLOR_LIME)
