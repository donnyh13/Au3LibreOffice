...
Func Example()
	...
	If (@error > 0) Then _ERROR("Failed to create a Table. Error:" & @error & " Extended:" & @extended)

	;Insert the Table
	$oTable = _LOWriter_TableInsert($oDoc, $oViewCursor, $oTable)
	If (@error > 0) Then _ERROR("Failed to insert the table. Error:" & @error & " Extended:" & @extended)
	...
	If (@error > 0) Then _ERROR("Failed to select the table. Error:" & @error & " Extended:" & @extended)
	...
	If (@error > 0) Then _ERROR("Failed to move a text cursor. Error:" & @error & " Extended:" & @extended)
	...
	If (@error > 0) Then _ERROR("Failed to select the TextCursor Data. Error:" & @error & " Extended:" & @extended)
