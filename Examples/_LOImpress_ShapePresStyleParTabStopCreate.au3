...
Func Example()
	...
	_LOImpress_ShapePresStyleParAlignment($oStyle, $LOI_PAR_ALIGN_HOR_LEFT)
	...
	$iTabStop = _LOImpress_ShapePresStyleParTabStopCreate($oStyle, $iHMM, $LOI_PAR_TAB_ALIGN_DECIMAL, Asc("."), Asc("~"))
