...
Func Example()
	...
	; Modify the Cell Gradient settings to: Preset Gradient name = $LOI_GRAD_NAME_SUNDOWN
	_LOImpress_TableCellBackGradient($oDoc, $oCell, $LOI_GRAD_NAME_SUNDOWN)
	...
	$avStops = _LOImpress_TableCellBackGradientMulticolor($oCell)
	...
	_LOImpress_TableCellBackGradientMulticolor($oCell, $avStops)
