...
Func Example()
	...
	_LOBase_QueryAddBySQL($oConnection, "qryAutoIt_Query", "SELECT * FROM ""tblNew_Table""")
	...
	_LOBase_QueryAddBySQL($oConnection, "qryNew_AutoIt_Query", "SELECT * FROM ""qryAutoIt_Query""")
	If @error Then Return _ERROR($oDoc, "Failed to add a Query to the Database. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)
