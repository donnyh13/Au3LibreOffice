...
Func Example()
	...
	; Set the Cell's underline settings to Underline style $LOI_CHAR_UNDERLINE_BOLD_DASH_DOT, Color to $LO_COLOR_BROWN, and Words only = True
	_LOImpress_TableCellCharUnderLine($oCell, $LOI_CHAR_UNDERLINE_BOLD_DASH_DOT, $LO_COLOR_BROWN, True)
	...
	$avSettings = _LOImpress_TableCellCharUnderLine($oCell)
