...
Func Example()
	...
	; Create a Find Format Search Array for $LOW_CHAR_UNDERLINE_BOLD_DASH underline style.
	_LOWriter_FindFormatModifyUnderline($atFindFormat, $LOW_CHAR_UNDERLINE_BOLD_DASH)
	If @error Then _ERROR($oDoc, "Failed to modify a Find format array. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)

	; Search for the word "search" that is underlined using $LOW_CHAR_UNDERLINE_BOLD_DASH line style.
