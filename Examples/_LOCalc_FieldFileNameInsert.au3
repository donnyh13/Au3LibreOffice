...
Func Example()
	...
	; Insert a File Name in the Header.
	_LOCalc_FieldFileNameInsert($oDoc, $oTextCursor, False)
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "I have inserted a File name field on the left side first page header." & @CRLF & _
