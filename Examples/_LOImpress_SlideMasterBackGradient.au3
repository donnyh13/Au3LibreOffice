...
Func Example()
	...
	; Modify the Master Slide Gradient settings to: skip pre-set gradient name, Gradient type = $LOI_GRAD_TYPE_SQUARE, increment steps = 150,
	...
	_LOImpress_SlideMasterBackGradient($oMaster, Null, $LOI_GRAD_TYPE_SQUARE, 150, 25, 56, 135, 50, $LO_COLOR_ORANGE, $LO_COLOR_TEAL, 100, 68)
	...
	$avSettings = _LOImpress_SlideMasterBackGradient($oMaster)
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "The Master Slide's Gradient settings are as follows: " & @CRLF & _
