...
Func Example()
	...
	_LOImpress_ShapePresStyleAreaGradient($oDoc, $oStyle, $LOI_GRAD_NAME_BLUE_TOUCH)
	...
	$avSettings = _LOImpress_ShapePresStyleAreaGradient($oDoc, $oStyle)
	...
	_LOImpress_ShapePresStyleAreaGradient($oDoc, $oStyle, Null, $LOI_GRAD_TYPE_SQUARE, 150, 25, 56, 135, 50, $LO_COLOR_ORANGE, $LO_COLOR_TEAL, 100, 68)
	If @error Then _ERROR($oDoc, "Failed to set Style settings. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)
