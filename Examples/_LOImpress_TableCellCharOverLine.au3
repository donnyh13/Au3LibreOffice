...
Func Example()
	...
	; Set the Cell's Overline settings to Overline style $LOI_CHAR_UNDERLINE_BOLD_DASH_DOT, Color to $LO_COLOR_BROWN, and Words only = True
	_LOImpress_TableCellCharOverLine($oCell, $LOI_CHAR_UNDERLINE_BOLD_DASH_DOT, $LO_COLOR_BROWN, True)
	...
	$avSettings = _LOImpress_TableCellCharOverLine($oCell)
