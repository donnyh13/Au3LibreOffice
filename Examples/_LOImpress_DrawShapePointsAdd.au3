...
Func Example()
	...
	; Insert a FreeForm Line Shape into the document, 5000 Wide by 0 High.
	$oShape = _LOImpress_DrawShapeInsert($oSlide, $LOI_DRAWSHAPE_TYPE_LINE_FREEFORM_LINE, 5000, 0)
