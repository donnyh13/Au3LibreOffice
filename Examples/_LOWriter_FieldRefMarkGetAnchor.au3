...
Func Example()
	...
	If @error Then _ERROR("Failed to Retrieve a Reference Mark anchor. Error:" & @error & " Extended:" & @extended)

	; Move the Anchor (Text Cursor)
	_LOWriter_CursorMove($oRefAnchor, $LOW_TEXTCUR_GO_RIGHT, 1, False)
	If @error Then _ERROR("Failed to move a cursor. Error:" & @error & " Extended:" & @extended)
