...
Func Example()
	...
	_LOWriter_FormConFormattedFieldData($oControl, "Datafield1", True, False, True)
	...
	$avControl = _LOWriter_FormConFormattedFieldData($oControl)
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "The Control's current settings are: " & @CRLF & _
			...
			"Is an empty entry value considered a Null value? True/False: " & $avControl[1] & @CRLF & _
			"Is user input required? True/False: " & $avControl[2] & @CRLF & _
			"Is the filter proposal active? True/False: " & $avControl[3])
