...
Func Example()
	...
	; Set the Shape's Indent settings to, 1/4" Before paragraph, 1/2" after paragraph, First line indent = 1",
	_LOImpress_ShapeParIndent($oTextBox, $iHMM, $iHMM2, $iHMM3)
	...
	$avSettings = _LOImpress_ShapeParIndent($oTextBox)
