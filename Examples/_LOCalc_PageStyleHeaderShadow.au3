...
Func Example()
	...
	; Set Page style Header Shadow settings to: Location = $LOC_SHADOW_LOCATION_TOP_LEFT, Color = $LO_COLOR_RED, Width = 1/8"
	_LOCalc_PageStyleHeaderShadow($oPageStyle, $LOC_SHADOW_LOCATION_TOP_LEFT, $LO_COLOR_RED, $iHMM)
