...
Func Example()
	...
	; Set the Overline settings to, Underline style $LOC_CHAR_UNDERLINE_BOLD_DASH_DOT, underline color = Gold, and Underline words only.
	_LOCalc_TextCursorOverline($oTextCursor, $LOC_CHAR_UNDERLINE_BOLD_DASH_DOT, $LO_COLOR_GOLD, True)
