...
Func Example()
	...
	$iTabStop = _LOImpress_ShapeParTabStopCreate($oTextBox, $iHMM)
	...
	_LOImpress_ShapeParTabStopMod($oTextBox, $iTabStop, $iHMM, $LOI_PAR_TAB_ALIGN_DECIMAL, Asc("."), Asc("~"))
	$iTabStop = @extended
	...
	$avTabStop = _LOImpress_ShapeParTabStopMod($oTextBox, $iTabStop)
