...
Func Example()
	...
	; Set the Cell's Alignment settings to, Horizontal alignment = $LOI_PAR_ALIGN_HOR_JUSTIFIED,
	; Last line alignment = $LOI_PAR_LAST_LINE_JUSTIFIED, Text direction = $LOI_PAR_TXT_DIR_LR_TB
	_LOImpress_TableCellParAlignment($oCell, $LOI_PAR_ALIGN_HOR_JUSTIFIED, $LOI_PAR_LAST_LINE_JUSTIFIED, $LOI_PAR_TXT_DIR_LR_TB)
	...
	$avSettings = _LOImpress_TableCellParAlignment($oCell)
