...
Func Example()
	...
	_LOWriter_ImageTypePosition($oImage, $LOW_ORIENT_HORI_CENTER, Null, $LOW_RELATIVE_PAGE, True, $LOW_ORIENT_VERT_NONE, $iHMM, _
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "The Image's position settings are as follows: " & @CRLF & _
			...
			"The Image's Horizontal position is, in Hundredths of a Millimeter (HMM): " & $avSettings[1] & @CRLF & _
			...
			"The Image's Vertical position is, in Hundredths of a Millimeter (HMM): " & $avSettings[5] & @CRLF & _
