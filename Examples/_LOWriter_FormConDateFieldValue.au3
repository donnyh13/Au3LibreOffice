...
Func Example()
	...
	$tDate = _LOWriter_DateStructCreate()
	...
	_LOWriter_FormConDateFieldValue($oControl, $tDate)
	...
	$tCurDate = _LOWriter_FormConDateFieldValue($oControl)
	...
	$avDate = _LOWriter_DateStructModify($tCurDate)
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "The Control's current Date value is: " & @CRLF & _
			"The Year is: " & $avDate[0] & @CRLF & _
			"The Month is: " & $avDate[1] & @CRLF & _
			"The Day is: " & $avDate[2])
