...
Func Example()
	...
	; Retrieve a count of Pivot Tables.
	$iCount = _LOCalc_RangePivotsGetCount($oSheet)
	If @error Then _ERROR($oDoc, "Failed to retrieve count of Pivot Tables for this sheet. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)

	MsgBox($MB_OK + $MB_TOPMOST, Default, "There are currently " & $iCount & " Pivot Table in this current Sheet.")
