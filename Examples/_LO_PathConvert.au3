...
Func Example()
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "Auto_Return -- Computer Path" & @CRLF & "This is the result from converting a Computer path to Libre Office URL automatically." & @CRLF & @CRLF & _
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "Auto_Return -- Libre Office URL" & @CRLF & "This is the result from converting a Libre Office URL to Computer Path automatically." & @CRLF & @CRLF & _
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "PCPATH_RETURN -- Libre Office URL" & @CRLF & "This is the result from converting a Libre Office URL to Computer Path." & @CRLF & @CRLF & _
			"Original Path: " & @CRLF & $sOfficePath & @CRLF & @CRLF & "Result: " & @CRLF & _
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "OFFICE_RETURN -- Computer Path" & @CRLF & "This is the result from converting a Computer Path to Libre Office URL." & @CRLF & @CRLF & _
			"Original Path: " & @CRLF & $sPCPath & @CRLF & @CRLF & "Result: " & @CRLF & _
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "OFFICE_RETURN -- Libre Office URL" & @CRLF & "This is the result from converting a Computer Path to Libre Office URL " & _
			"when the path is already a Libre Office URL." & @CRLF & @CRLF & _
			"Original Path: " & @CRLF & $sOfficePath & @CRLF & @CRLF & "Result: " & @CRLF & _
