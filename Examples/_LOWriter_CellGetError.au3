...
Func Example()
	...
	If @error Then _ERROR("Failed to set Text Table cell formula. Error:" & @error & " Extended:" & @extended)

	; Retrieve the error value
	$iError = _LOWriter_CellGetError($oCell)
	If @error Then _ERROR("Failed to retrieve Table Cell formula error value. Error:" & @error & " Extended:" & @extended)

	; Retrieve the Cell Formula.
	$sFormula = _LOWriter_CellFormula($oCell)
	If @error Then _ERROR("Failed to retrieve Text Table cell Formula. Error:" & @error & " Extended:" & @extended)
