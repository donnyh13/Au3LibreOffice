...
Func Example()
	...
	; Set the Cell's Strikeout settings to, Line style = $LOI_CHAR_STRIKEOUT_X, Words only = True.
	_LOImpress_TableCellCharStrikeOut($oCell, $LOI_CHAR_STRIKEOUT_X, True)
	...
	$avSettings = _LOImpress_TableCellCharStrikeOut($oCell)
