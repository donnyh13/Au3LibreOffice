...
Func Example()
	...
	_LO_TransparencyGradientMultiAdd($avStops, 1, 0.4, 55)
	...
	_LO_TransparencyGradientMultiAdd($avStops, 2, 0.7, 70)
	If @error Then _ERROR($oDoc, "Failed to add a ColorStop. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)
	...
	_LO_TransparencyGradientMultiModify($avStops, 0, 0.2, 10)
	...
	_LO_TransparencyGradientMultiModify($avStops, (UBound($avStops) - 1), 0.9, 85)
	If @error Then _ERROR($oDoc, "Failed to modify a ColorStop. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)
