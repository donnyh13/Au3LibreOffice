...
Func Example()
	...
	;Set Page style Header Border Color settings to: Top, $LOW_COLOR_ORANGE, Bottom $LOW_COLOR_BLUE, Left, $LOW_COLOR_LGRAY, Right $LOW_COLOR_BLACK
	_LOWriter_PageStyleHeaderBorderColor($oPageStyle, $LOW_COLOR_ORANGE, $LOW_COLOR_BLUE, $LOW_COLOR_LGRAY, $LOW_COLOR_BLACK)
	If (@error > 0) Then _ERROR("Failed to modify Page Style settings. Error:" & @error & " Extended:" & @extended)
	...
	MsgBox($MB_OK, "", "The Page Style's current Header Border Color settings are as follows: " & @CRLF & _
