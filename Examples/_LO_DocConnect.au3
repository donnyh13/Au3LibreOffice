...
Func Example()
	...
	_LOBase_TableDocOpenByObject($oBaseDoc, $oConnection, $oTable)
	If @error Then Return _ERROR($oBaseDoc, $oCalcDoc, $oWriterDoc, "Failed to open Table Document. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)

	; Open the Table Document in Design Mode.
	_LOBase_TableDocOpenByObject($oBaseDoc, $oConnection, $oTable, True)
	If @error Then Return _ERROR($oBaseDoc, $oCalcDoc, $oWriterDoc, "Failed to open Table Document. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)
	...
	If @error Then Return _ERROR($oBaseDoc, $oCalcDoc, $oWriterDoc, "Failed to open Query Document. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)
