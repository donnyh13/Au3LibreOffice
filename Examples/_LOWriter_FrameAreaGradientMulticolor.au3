...
Func Example()
	...
	_LOWriter_FrameAreaGradient($oDoc, $oFrame, $LOW_GRAD_NAME_SUNDOWN)
	...
	$avStops = _LOWriter_FrameAreaGradientMulticolor($oFrame)
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "The Frame's Gradient ColorStops are as follows: " & @CRLF & _
			$sStops & @CRLF & @CRLF & _
	...
	_LOWriter_FrameAreaGradientMulticolor($oFrame, $avStops)
