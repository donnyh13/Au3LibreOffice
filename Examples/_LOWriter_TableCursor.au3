...
Func Example()
	...
	If @error Then _ERROR("Failed to merge Table cells. Error:" & @error & " Extended:" & @extended)
	...
	If @error Then _ERROR("Failed to Split Table cell. Error:" & @error & " Extended:" & @extended)
