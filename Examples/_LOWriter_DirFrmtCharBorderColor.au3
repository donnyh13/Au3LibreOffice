...
Func Example()
	...
	$avSettings = _LOWriter_DirFrmtCharBorderColor($oViewCursor)
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "The selected text's current Character Border color settings are as follows: " & @CRLF & _
