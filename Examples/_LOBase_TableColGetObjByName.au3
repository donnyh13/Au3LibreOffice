...
Func Example()
	...
	Local $sSavePath
	Local $asColumns[0], $asSettings[0]
	...
	; Retrieve an array of Column names.
	...
	For $i = 0 To @extended - 1
		; Retrieve the object for the column by name.
		$oColumn = _LOBase_TableColGetObjByName($oTable, $asColumns[$i])
