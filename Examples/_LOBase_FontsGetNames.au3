...
Func Example()
	...
	If @error Then _ERROR($oDoc, $oTableUI, "Failed to retrieve Array of font names. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)
	...
	If @error Then Return _ERROR($oDoc, $oTableUI, "Failed to create a Prepared Statement. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)
	...
	For $i = 0 To UBound($asFonts) - 1
		...
		If @error Then Return _ERROR($oDoc, $oTableUI, "Failed to set Prepared Statement data. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)
		...
		If @error Then Return _ERROR($oDoc, $oTableUI, "Failed to Execute Prepared Statement. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)
