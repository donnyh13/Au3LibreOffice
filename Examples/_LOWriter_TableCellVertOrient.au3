...
Func Example()
	...
	_LOWriter_TableCellString($oCell, "This Test Text.")
	...
	_LOWriter_TableCellString($oCell2, @CR)
	If @error Then _ERROR($oDoc, "Failed to set Text Table cell text. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)

	$iVertOrient = _LOWriter_TableCellVertOrient($oCell)
	...
	_LOWriter_TableCellVertOrient($oCell, $LOW_ORIENT_VERT_BOTTOM)
	...
	; Set A1 Table Cell's Text.
	_LOWriter_TableCellString($oCell, "Text vertically aligned to the bottom.")
	If @error Then _ERROR($oDoc, "Failed to set Text Table cell text. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)

	MsgBox($MB_OK + $MB_TOPMOST, Default, "I have now set the Vertical Orientation to $LOW_ORIENT_VERT_BOTTOM(3).")

	_LOWriter_TableCellVertOrient($oCell, $LOW_ORIENT_VERT_CENTER)
	If @error Then _ERROR($oDoc, "Failed to set Text Table cell vertical orientation. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)

	; Set A1 Table Cell's Text.
	_LOWriter_TableCellString($oCell, "Text vertically aligned to the Center.")
	If @error Then _ERROR($oDoc, "Failed to set Text Table cell text. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)

	MsgBox($MB_OK + $MB_TOPMOST, Default, "I have now set the Vertical Orientation to $LOW_ORIENT_VERT_CENTER(2).")

	_LOWriter_TableCellVertOrient($oCell, $LOW_ORIENT_VERT_TOP)
	If @error Then _ERROR($oDoc, "Failed to set Text Table cell vertical orientation. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)

	; Set A1 Table Cell's Text.
	_LOWriter_TableCellString($oCell, "Text vertically aligned to the Top.")
	If @error Then _ERROR($oDoc, "Failed to set Text Table cell text. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)
