...
Func Example()
	...
	; Connect to the Table UI.
	$oTableUI = _LOBase_TableUIConnect($LO_DOC_CONNECT_MODE_CURRENT)
	If @error Then Return _ERROR($oDoc, "Failed to connect to Table UI. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)
