...
Func Example()
	...
	; Set the Style's Indent settings to, 1/4" Before paragraph, 1/2" after paragraph, First line indent = 1",
	_LOImpress_ShapePresStyleParIndent($oStyle, $iHMM, $iHMM2, $iHMM3)
	...
	$avSettings = _LOImpress_ShapePresStyleParIndent($oStyle)
