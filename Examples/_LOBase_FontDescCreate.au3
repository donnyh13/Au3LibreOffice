...
Func Example()
	...
	$mFont = _LOBase_FontDescCreate("Times New Roman", $LOB_CHAR_WEIGHT_BOLD, $LOB_CHAR_POSTURE_ITALIC, 18, $LO_COLOR_BRICK, $LOB_CHAR_UNDERLINE_BOLD, $LO_COLOR_GREEN, $LOB_CHAR_STRIKEOUT_NONE, True, $LOB_CHAR_RELIEF_NONE)
