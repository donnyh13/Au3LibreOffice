...
Func Example()
	...
	_LOWriter_DirFrmtStrikeOut($oViewCursor, Null, $LOW_STRIKEOUT_SINGLE)
	...
	_LOWriter_FindFormatModifyStrikeout($atFindFormat, Null, $LOW_STRIKEOUT_SINGLE)
	...
	If IsObj($oResult) Then
		...
		MsgBox($MB_OK + $MB_TOPMOST, Default, "The search was successful, I searched using a Find Format, looking for a struck out word, and found the following: " & $sResultString)
