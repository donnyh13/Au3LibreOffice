...
Func Example()
	...
	If @error Then Return _ERROR($oDoc, "Failed to retrieve array of Table names. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)
	...
	If @error Then Return _ERROR($oDoc, "Failed to delete the Table. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)
