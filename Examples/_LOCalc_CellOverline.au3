...
Func Example()
	...
	; Set the Cell's Overline settings to Overline style $LOC_UNDERLINE_BOLD_DASH_DOT, Color to $LO_COLOR_BROWN, and Words only = True
	_LOCalc_CellOverLine($oCell, $LOC_UNDERLINE_BOLD_DASH_DOT, $LO_COLOR_BROWN, True)
