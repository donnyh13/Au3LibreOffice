...
Func Example()
	...
	; Set the Cell's Overline settings to Words only = True, Overline style $LOC_UNDERLINE_BOLD_DASH_DOT, and Color to $LO_COLOR_BROWN
	_LOCalc_CellOverLine($oCell, True, $LOC_UNDERLINE_BOLD_DASH_DOT, $LO_COLOR_BROWN)
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "The Cell's current Overline settings are as follows: " & @CRLF & _
			...
			"Overline color (as a RGB Color Integer): " & $avSettings[2])
