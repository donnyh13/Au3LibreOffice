...
Func Example()
	...
	; Set the Cell Style's Shadow location to $LOC_SHADOW_LOCATION_TOP_LEFT, Color to $LO_COLOR_PURPLE, and 1/4" wide
	_LOCalc_CellStyleShadow($oCellStyle, $LOC_SHADOW_LOCATION_TOP_LEFT, $LO_COLOR_PURPLE, $iHMM)
