...
Func Example()
	...
	_LOImpress_ShapeStyleParAlignment($oStyle, $LOI_PAR_ALIGN_HOR_JUSTIFIED, $LOI_PAR_LAST_LINE_JUSTIFIED, $LOI_PAR_TXT_DIR_LR_TB)
	...
	$avSettings = _LOImpress_ShapeStyleParAlignment($oStyle)
