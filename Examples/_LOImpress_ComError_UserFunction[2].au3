...
Func Example()
	...
	$oCOM_Error = ObjEvent("AutoIt.Error", "__LOImpress_InternalComErrorHandler")
	#forceref $oCOM_Error
	...
	_LOImpress_ComError_UserFunction($MyFunc, "My First Parameter", 2023, "I have only three Parameters now.")
	If @error Then _ERROR("Error Assigning User COM Error Function. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)
	...
	$aReturn = _LOImpress_ComError_UserFunction(Default) ; Since I set parameters, the return will be an Array.
	...
	_LOImpress_ComError_UserFunction(Null)
