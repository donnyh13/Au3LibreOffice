...
Func Example()
	...
	; Insert some text.
	_LOWriter_CursorInsertString($oDoc, $oViewCursor, "The Paragraph Styles available in this document are:" & @CR & @CR)
	...
	; Insert some text.
	_LOWriter_CursorInsertString($oDoc, $oViewCursor, "The Paragraph Styles currently in use in this document are:" & @CR & @CR, True)
	If @error Then _ERROR($oDoc, "Failed to insert text. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)
