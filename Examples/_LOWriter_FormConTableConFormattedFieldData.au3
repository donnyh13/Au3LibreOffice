...
Func Example()
	...
	_LOWriter_FormConTableConFormattedFieldData($oColumn, "Testing", True, True, False)
	...
	$avColumn = _LOWriter_FormConTableConFormattedFieldData($oColumn)
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "The Column's current settings are: " & @CRLF & _
			...
			"Is an empty entry value considered a Null value? True/False: " & $avColumn[1] & @CRLF & _
