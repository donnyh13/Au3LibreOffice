...
Func Example()
	...
	$oControl = _LOBase_ReportConInsert($oSection, $LOB_REP_CON_TYPE_IMAGE_CONTROL, 10500, 500, 4000, 2000)
	...
	_LOBase_ReportConImageConData($oControl, "field:[Value_Col]")
	...
	$sDatafield = _LOBase_ReportConImageConData($oControl)
