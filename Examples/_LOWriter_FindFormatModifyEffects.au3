...
Func Example()
	...
	_LOWriter_DirFrmtCharEffect($oViewCursor, Null, $LOW_CASEMAP_SM_CAPS)
	...
	_LOWriter_FindFormatModifyEffects($atFindFormat, Null, $LOW_CASEMAP_SM_CAPS)
	...
	If IsObj($oResult) Then
		...
		MsgBox($MB_OK, "", "The search was successful, I searched using a Find Format, looking for any words in Small Caps, and found the following: " & $sResultString)
	Else
