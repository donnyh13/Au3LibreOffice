...
Func Example()
	...
	; Set Page style Header Shadow settings to: Location = $LOW_SHADOW_LOCATION_TOP_LEFT, Color = $LO_COLOR_RED, Width = 1/8"
	_LOWriter_PageStyleHeaderShadow($oPageStyle, $LOW_SHADOW_LOCATION_TOP_LEFT, $LO_COLOR_RED, $iHMM)
