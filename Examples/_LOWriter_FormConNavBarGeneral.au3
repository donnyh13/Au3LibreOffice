...
Func Example()
	...
	_LOWriter_FormConNavBarGeneral($oControl, "Renamed_AutoIt_Control", Null, True, True, True, 2, 50, $mFont, $LO_COLOR_GOLD, $LOW_FORM_CON_BORDER_3D, False, True, True, True, True, "Some Additional Information", "This is Help Text", "www.HelpURL.fake")
