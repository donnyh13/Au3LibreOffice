...
Func Example()
	...
	If @error Then Return _ERROR($oDoc, "Failed to retrieve count of Columns. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)
	...
	For $i = 0 To $iCount - 1
		...
		MsgBox($MB_OK + $MB_TOPMOST, Default, "The Column with Index number " & $i & " has the name of: " & $asSettings[0])
	Next
