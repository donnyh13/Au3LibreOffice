...
Func Example()
	...
	; Delete Folder2
	_LOBase_ReportFolderDelete($oDoc, "AutoIt_Folder/Folder2")
	If @error Then Return _ERROR($oDoc, "Failed to delete folder. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)
