...
Func Example()
	...
	$asMasters = _LOImpress_SlideMastersGetNames($oDoc)
	...
	$oMaster = _LOImpress_SlideMasterGetObjByName($oDoc, $asMasters[0])
	If @error Then _ERROR($oDoc, "Failed to retrieve Master Slide Object. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)

	; Set the Master Slide's background color to Blue.
	_LOImpress_SlideMasterBackColor($oMaster, $LO_COLOR_BLUE)
