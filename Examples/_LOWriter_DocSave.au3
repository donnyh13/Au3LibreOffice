...
Func Example()
	...
	If @error Then _ERROR("Failed to retrieve View Cursor for the Writer Document. Error:" & @error & " Extended:" & @extended)

	; Insert some text
	_LOWriter_DocInsertString($oDoc, $oViewCursor, "This is some text to test saving a document.")
	If @error Then _ERROR("Failed to insert a String into the Writer Document. Error:" & @error & " Extended:" & @extended)
