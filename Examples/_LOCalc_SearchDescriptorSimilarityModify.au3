...
Func Example()
	...
	; Set similarity to Similarity search = True, Combine = False, Number of characters that can be removed = 2, Number of characters that can be added = 3,
	; Number of characters that can be exchanged = 1
	...
	$aoResults = _LOCalc_RangeFindAll($oSheet, $oSrchDesc, "Seven")
