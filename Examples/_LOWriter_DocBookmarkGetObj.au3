...
Func Example()
	...
	If @error Then _ERROR("Failed to retrieve a BookMark Object. Error:" & @error & " Extended:" & @extended)

	; Modify the Bookmark name to "Old Bookmark"
	_LOWriter_DocBookmarkModify($oDoc, $oBookmark, "Old Bookmark")
	If @error Then _ERROR("Failed to modify a Bookmark. Error:" & @error & " Extended:" & @extended)
