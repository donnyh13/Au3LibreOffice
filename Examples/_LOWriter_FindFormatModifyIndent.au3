...
Func Example()
	...
	If IsObj($oResult) Then
		...
		MsgBox($MB_OK + $MB_TOPMOST, Default, "The search was successful, I searched using a Find Format, looking for any paragraphs that have the first line Auto Indent, " & _
