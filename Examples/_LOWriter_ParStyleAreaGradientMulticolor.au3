...
Func Example()
	...
	; Set Paragraph style Gradient settings to: Preset Gradient name = $LOW_GRAD_NAME_SUNDOWN
	_LOWriter_ParStyleAreaGradient($oDoc, $oParStyle, $LOW_GRAD_NAME_SUNDOWN)
	...
	$avStops = _LOWriter_ParStyleAreaGradientMulticolor($oParStyle)
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "The Paragraph Style's Gradient ColorStops are as follows: " & @CRLF & _
			$sStops & @CRLF & @CRLF & _
	...
	_LOWriter_ParStyleAreaGradientMulticolor($oParStyle, $avStops)
