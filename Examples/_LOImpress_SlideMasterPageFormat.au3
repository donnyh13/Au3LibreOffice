...
Func Example()
	...
	_LOImpress_SlideMasterPageFormat($oMaster, $LOI_PAGE_WIDTH_DIA_SLIDE, $LOI_PAGE_HEIGHT_DIA_SLIDE, $LOI_PAGE_ORIENT_PORTRAIT)
	...
	$avSettings = _LOImpress_SlideMasterPageFormat($oMaster)
