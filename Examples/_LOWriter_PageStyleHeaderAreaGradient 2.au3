...
Func Example()
	...
	;Set Page style Header Gradient settings to: skip pre-set gradient name,, Gradient type = $LOW_GRAD_TYPE_SQUARE, increment steps = 150,
	...
	_LOWriter_PageStyleHeaderAreaGradient($oDoc, $oPageStyle, Null, $LOW_GRAD_TYPE_SQUARE, 150, 25, 56, 135, 50, $LOW_COLOR_ORANGE, $LOW_COLOR_TEAL, 100, 68)
