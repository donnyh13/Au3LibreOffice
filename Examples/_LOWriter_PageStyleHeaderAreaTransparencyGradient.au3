...
Func Example()
	...
	$avPageStyleSettings = _LOWriter_PageStyleHeaderAreaTransparencyGradient($oDoc, $oPageStyle)
	If @error Then _ERROR($oDoc, "Failed to retrieve the Page style settings. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)

	MsgBox($MB_OK + $MB_TOPMOST, Default, "The Page Style's current Header Transparency Gradient settings are as follows: " & @CRLF & _
