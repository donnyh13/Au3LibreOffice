...
Func Example()
	...
	; Set "Example" Character style underline settings to Underline style $LOW_CHAR_UNDERLINE_BOLD_DASH_DOT, Color to $LO_COLOR_BROWN, and Words only = True
	_LOWriter_CharStyleUnderLine($oCharStyle, $LOW_CHAR_UNDERLINE_BOLD_DASH_DOT, $LO_COLOR_BROWN, True)
