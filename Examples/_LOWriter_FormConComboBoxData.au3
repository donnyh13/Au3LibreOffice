...
Func Example()
	...
	_LOWriter_FormConComboBoxData($oControl, "Datafield1", False, True, $LOW_FORM_CON_SOURCE_TYPE_TABLE, "Testing_1")
	...
	$avControl = _LOWriter_FormConComboBoxData($oControl)
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "The Control's current settings are: " & @CRLF & _
			...
			"Is a empty value considered as a Null value? True/False: " & $avControl[1] & @CRLF & _
			"Is user input required? True/False: " & $avControl[2] & @CRLF & _
			"What type of content is used to fill the combo box? (See UDF Constants): " & $avControl[3] & @CRLF & _
			"The List content source is: " & $avControl[4])
