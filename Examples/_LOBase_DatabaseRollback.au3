...
Func Example()
	...
	_LOBase_DatabaseRollback($oConnection)
	If @error Then Return _ERROR($oDoc, "Failed to Commit changes to the Database. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)
