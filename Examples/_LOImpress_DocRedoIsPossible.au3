...
Func Example()
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "Is a Redo operation possible? True/False: " & _LOImpress_DocRedoIsPossible($oDoc))
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "Now is a Redo operation possible? True/False: " & _LOImpress_DocRedoIsPossible($oDoc))
