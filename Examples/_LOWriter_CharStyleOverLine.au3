...
Func Example()
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "The Character style's current Overline settings are as follows: " & @CRLF & _
			"Overline style (See UDF constants): " & $avCharStyleSettings[0] & @CRLF & _
			"Overline color is (as a RGB Color Integer): " & $avCharStyleSettings[1] & @CRLF & _
			"Overline words only? True/False: " & $avCharStyleSettings[2])
