...
Func Example()
	...
	If @error Then _ERROR("Failed to retrieve Text Table Object using View Cursor. Error:" & @error & " Extended:" & @extended)

	MsgBox($MB_OK, "", "I will now delete the table.")

	; Delete the Table.
	_LOWriter_TableDelete($oDoc, $oTableNewObj)
	If @error Then _ERROR("Failed to delete Text Table. Error:" & @error & " Extended:" & @extended)
