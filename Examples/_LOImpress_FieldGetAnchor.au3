...
Func Example()
	Local $oDoc, $oSlide, $oTextBox, $oTextCursor, $oField, $oAnchorCursor
	...
	$oField = _LOImpress_FieldHyperlinkInsert($oDoc, $oTextCursor, "www.autoitscript.com/site/autoit/", "AutoIt v3")
	If @error Then _ERROR($oDoc, "Failed to insert a field. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)

	; Create a Text Cursor at the Field's Anchor.
	$oAnchorCursor = _LOImpress_FieldGetAnchor($oField)
	If @error Then _ERROR($oDoc, "Failed to create a Text Cursor at the Field's Anchor. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)

	; Move the cursor to the beginning of the text.
	_LOImpress_CursorMove($oAnchorCursor, $LOI_TEXTCUR_GOTO_START)
	...
	_LOImpress_CursorInsertString($oAnchorCursor, "This UDF was created with ")
