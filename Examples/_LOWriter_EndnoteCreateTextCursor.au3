...
Func Example()
	...
	; Insert some text.
	_LOWriter_CursorInsertString($oDoc, $oViewCursor, "I have inserted a Endnote at the end of this line. ")
	...
	$oTextCursor = _LOWriter_EndnoteCreateTextCursor($oEndnote)
	...
	_LOWriter_CursorInsertString($oDoc, $oTextCursor, "I inserted some text inside of the Endnote.")
	If @error Then _ERROR($oDoc, "Failed to insert text. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)
