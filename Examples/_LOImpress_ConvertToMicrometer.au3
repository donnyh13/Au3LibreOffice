...
Func Example()
	...
	$iInch_To_MicroM = _LOImpress_ConvertToMicrometer(1)
	...
	$iCM_To_MicroM = _LOImpress_ConvertToMicrometer(Null, 2.54)
	...
	$iMM_To_MicroM = _LOImpress_ConvertToMicrometer(Null, Null, 25.4)
	...
	$iPt_To_MicroM = _LOImpress_ConvertToMicrometer(Null, Null, Null, 72)
	If @error Then _ERROR("Failed to convert to Micrometers from Millimeter. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)
