...
Func Example()
	...
	; Set Page style Gradient settings to: Preset Gradient name = $LOW_GRAD_NAME_SUNDOWN
	_LOWriter_PageStyleAreaGradient($oDoc, $oPageStyle, $LOW_GRAD_NAME_SUNDOWN)
	If @error Then _ERROR($oDoc, "Failed to modify Page Style settings. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)

	; Retrieve an array of Multicolor Gradient ColorStops.
	$avStops = _LOWriter_PageStyleAreaGradientMulticolor($oPageStyle)
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "The Page Style's Gradient ColorStops are as follows: " & @CRLF & _
			$sStops & @CRLF & @CRLF & _
	...
	_LOWriter_PageStyleAreaGradientMulticolor($oPageStyle, $avStops)
