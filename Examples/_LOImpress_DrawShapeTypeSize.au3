...
Func Example()
	...
	; Convert 3" to Hundredths of a Millimeter (100th MM)
	$i100thMM = _LO_UnitConvert(3, $LO_CONVERT_UNIT_INCH_100THMM)
	...
	; Convert 4" to Hundredths of a Millimeter (100th MM)
	$i100thMM2 = _LO_UnitConvert(4, $LO_CONVERT_UNIT_INCH_100THMM)
	If @error Then _ERROR($oDoc, "Failed to convert from inches to Hundredths of a Millimeter (100th MM). Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)

	; Modify the Shape Size settings. Width = 3", Height = 4", Protect Size = True
	_LOImpress_DrawShapeTypeSize($oShape, $i100thMM, $i100thMM2, True)
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "The Shape's size settings are as follows: " & @CRLF & _
			"The Shape's width is, in Hundredths of a Millimeter (100th MM): " & $avSettings[0] & @CRLF & _
			"The Shape's height is, in Hundredths of a Millimeter (100th MM): " & $avSettings[1] & @CRLF & _
