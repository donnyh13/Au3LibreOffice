...
Func Example()
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "Press Ok to Close Table Document and retrieve the date and time values.")
	...
	If @error Then Return _ERROR($oDoc, "Failed to modify Date and Time values. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)
	...
	If @error Then Return _ERROR($oDoc, "Failed to Update Result Row. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)
