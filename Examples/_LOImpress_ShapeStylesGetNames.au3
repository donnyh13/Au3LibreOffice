...
Func Example()
	...
	; Retrieve Array of Shape Style names.
	$asStyles = _LOImpress_ShapeStylesGetNames($oDoc)
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "I found " & UBound($asStyles) & " Shape Styles. Their names are:" & @CRLF & @CRLF & $sStyles)
