...
Func Example()
	...
	_LOImpress_ShapeStyleAreaGradient($oDoc, $oStyle, $LOI_GRAD_NAME_SUNDOWN)
	...
	$avStops = _LOImpress_ShapeStyleAreaGradientMulticolor($oStyle)
	...
	_LOImpress_ShapeStyleAreaGradientMulticolor($oStyle, $avStops)
