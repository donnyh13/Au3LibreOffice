...
Func Example()
	...
	_LOWriter_FormConPatternFieldGeneral($oControl, "Renamed_AutoIt_Control", $oLabel, Null, 75, "LLNNLNNLNN", "20__/__/__", True, True, True, False, True, $LOW_FORM_CON_MOUSE_SCROLL_DISABLED, True, 1, @YEAR & "/" & @MON & "/" & @MDAY, $mFont, $LOW_ALIGN_HORI_CENTER, $LOW_ALIGN_VERT_BOTTOM, $LO_COLOR_GOLD, $LOW_FORM_CON_BORDER_FLAT, $LO_COLOR_YELLOW, False, "Some Additional Information", "This is Help Text", "www.HelpURL.fake")
