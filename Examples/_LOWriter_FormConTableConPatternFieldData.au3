...
Func Example()
	...
	_LOWriter_FormConTableConPatternFieldData($oColumn, "Testing", True, True, True)
	...
	$avColumn = _LOWriter_FormConTableConPatternFieldData($oColumn)
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "The Column's current settings are: " & @CRLF & _
			...
			"Is an empty entry considered a Null value? True/False: " & $avColumn[1] & @CRLF & _
			"Is user input required? True/False: " & $avColumn[2] & @CRLF & _
			"Is the filter proposal active? True/False: " & $avColumn[3])
