...
Func Example()
	...
	_LOWriter_FormConListBoxData($oControl, "Datafield1", False, $LOW_FORM_CON_SOURCE_TYPE_VALUE_LIST, $asValues)
	...
	$avControl = _LOWriter_FormConListBoxData($oControl)
	...
	; Modify the Control's Data properties.
	_LOWriter_FormConListBoxData($oControl, "Datafield1", False, $LOW_FORM_CON_SOURCE_TYPE_TABLE, $asTables, 4)
	If @error Then _ERROR($oDoc, "Failed to modify the Control's properties. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)
