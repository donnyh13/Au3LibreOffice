...
Func Example()
	...
	If @error Then _ERROR("Failed to move TextCursor. Error:" & @error & " Extended:" & @extended)
	...
	If @error Then _ERROR("Failed to insert text at the TextCursor. Error:" & @error & " Extended:" & @extended)
