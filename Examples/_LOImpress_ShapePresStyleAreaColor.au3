...
Func Example()
	...
	$iColor = _LOImpress_ShapePresStyleAreaColor($oStyle)
	If @error Then _ERROR($oDoc, "Failed to retrieve Style's settings. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)

	MsgBox($MB_OK + $MB_TOPMOST, Default, "The Presentation Style's Background color settings are as follows: " & @CRLF & _
