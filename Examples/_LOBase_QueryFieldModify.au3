...
Func Example()
	...
	; Retrieve the first Query Field's Object.
	...
	; Modify the Alias for the Query Field, and set it to visible.
	_LOBase_QueryFieldModify($oQueryField, "First_Column", True)
	If @error Then Return _ERROR($oDoc, "Failed to set Query Field Settings. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)
