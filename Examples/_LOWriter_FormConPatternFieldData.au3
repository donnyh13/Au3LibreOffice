...
Func Example()
	...
	_LOWriter_FormConPatternFieldData($oControl, "Datafield1", False, True, False)
	...
	$avControl = _LOWriter_FormConPatternFieldData($oControl)
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "The Control's current settings are: " & @CRLF & _
			...
			"Is an empty entry considered a Null value? True/False: " & $avControl[1] & @CRLF & _
