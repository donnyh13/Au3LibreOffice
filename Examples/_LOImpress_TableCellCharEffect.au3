...
Func Example()
	...
	; Set the Cell's Font effects to $LOI_CHAR_RELIEF_EMBOSSED relief type.
	_LOImpress_TableCellCharEffect($oCell, Null, $LOI_CHAR_RELIEF_EMBOSSED)
	...
	$avSettings = _LOImpress_TableCellCharEffect($oCell)
	...
	; Set the Cell's Font effects to $LOI_CHAR_CASEMAP_SM_CAPS Case type type, with outlining.
	_LOImpress_TableCellCharEffect($oCell, $LOI_CHAR_CASEMAP_SM_CAPS, $LOI_CHAR_RELIEF_NONE, True, True)
