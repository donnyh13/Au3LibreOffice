...
Func Example()
	...
	_LOBase_ReportConInsert($oSection, $LOB_REP_CON_TYPE_IMAGE_CONTROL, 10500, 500, 4500, 1500)
	...
	_LOBase_ReportConInsert($oSection, $LOB_REP_CON_TYPE_TEXT_BOX, 1500, 800, 4000, 2000)
	If @error Then Return _ERROR($oDoc, $oReportDoc, "Failed to insert a Control. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)

	; Retrieve an Array of controls contained in the section.
