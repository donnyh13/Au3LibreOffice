...
Func Example()
	...
	_LOImpress_CursorCharEffect($oTextCursor, $LOI_CHAR_RELIEF_EMBOSSED)
	...
	_LOImpress_CursorCharEffect($oTextCursor, $LOI_CHAR_RELIEF_NONE, $LOI_CHAR_CASEMAP_SM_CAPS, True, True)
	If @error Then _ERROR($oDoc, "Failed to set the Selected text's settings. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)
