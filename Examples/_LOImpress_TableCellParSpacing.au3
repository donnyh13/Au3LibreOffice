...
Func Example()
	...
	Local $iColumns, $iRows, $iHMM, $iHMM2
	Local $avSettings
	...
	; Set the Cell's line space settings to, 1/4" above paragraph, 1/4" below paragraph,
	; Line space mode = $LOI_PAR_LINE_SPC_MODE_FIX, Line space height = 1/2".
	_LOImpress_TableCellParSpacing($oCell, $iHMM, $iHMM, $LOI_PAR_LINE_SPC_MODE_FIX, $iHMM2)
	...
	$avSettings = _LOImpress_TableCellParSpacing($oCell)
