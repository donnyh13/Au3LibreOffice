...
Func Example()
	...
	_LOCalc_CellStyleBorderPadding($oCellStyle, $iHMM)
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "Default Cell Style's Border Padding settings are as follows (in Hundredths of a Millimeter (HMM)): " & @CRLF & _
	...
	_LOCalc_CellStyleBorderPadding($oCellStyle, Null, $iHMM, $iHMM2, $iHMM2, $iHMM)
	If @error Then _ERROR($oDoc, "Failed to set Cell style settings. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)
