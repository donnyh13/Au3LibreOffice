...
Func Example()
	...
	; Set the Cell's underline settings to Words only = True, Underline style $LOC_UNDERLINE_BOLD_DASH_DOT, and Color to $LO_COLOR_BROWN
	_LOCalc_CellUnderLine($oCell, True, $LOC_UNDERLINE_BOLD_DASH_DOT, $LO_COLOR_BROWN)
