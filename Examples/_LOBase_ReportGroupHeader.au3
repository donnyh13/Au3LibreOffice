...
Func Example()
	...
	$avGroup = _LOBase_ReportGroupHeader($oGroup)
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "The Group's current settings are: " & @CRLF & _
			"Is the Group Header enabled? True/False: " & $avGroup[0] & @CRLF & _
			"The Group's name is: " & $avGroup[1] & @CRLF & _
			"Will a new page be created before/after this Group Header? If so, when? (See UDF Constants): " & $avGroup[2] & @CRLF & _
