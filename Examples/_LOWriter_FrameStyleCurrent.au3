...
Func Example()
	...
	; Set the Frame Style Background Color to $LO_COLOR_TEAL
	...
	; Retrieve the current Frame Style set for this Frame
	$sStyle = _LOWriter_FrameStyleCurrent($oDoc, $oFrame)
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "The current Frame Style used by this Frame is: " & $sStyle & @CRLF & @CRLF & _
			"I will now set the Frame's Frame style to my custom Frame Style with a Teal background.")
