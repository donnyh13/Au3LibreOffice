...
Func Example()
	...
	_LOCalc_FieldPageNumberInsert($oDoc, $oTextCursor)
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "I have inserted a Page Number field on the left side first page header." & @CRLF & _
