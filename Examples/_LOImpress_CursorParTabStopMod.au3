...
Func Example()
	...
	$iTabStop = _LOImpress_CursorParTabStopCreate($oTextCursor, $iHMM)
	...
	_LOImpress_CursorParTabStopMod($oTextCursor, $iTabStop, $iHMM, $LOI_PAR_TAB_ALIGN_DECIMAL, Asc("."), Asc("~"))
	$iTabStop = @extended
	...
	$avTabStop = _LOImpress_CursorParTabStopMod($oTextCursor, $iTabStop)
