...
Func Example()
	...
	$sString = _LOWriter_CellString($oCell)
	If (@error > 0) Then _ERROR("Failed to retrieve Text Table cell String. Error:" & @error & " Extended:" & @extended)

	MsgBox($MB_OK, "", "The Cell String is: " & $sString)
