...
Func Example()
	...
	_LOBase_ReportDocHeader($oReportDoc, True, "AutoIt_Section", $LOB_REP_FORCE_PAGE_AFTER_SECTION, False, True, 4500, Null, $LO_COLOR_TEAL)
	...
	$avReport = _LOBase_ReportDocHeader($oReportDoc)
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "The Section's current settings are: " & @CRLF & _
			"Is the Report Header enabled? True/False: " & $avReport[0] & @CRLF & _
