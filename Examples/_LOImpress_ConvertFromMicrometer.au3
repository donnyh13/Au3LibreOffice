...
Func Example()
	...
	$iInch_From_MicroM = _LOImpress_ConvertFromMicrometer(2540)
	...
	$iCM_From_MicroM = _LOImpress_ConvertFromMicrometer(Null, 2540)
	...
	$iMM_From_MicroM = _LOImpress_ConvertFromMicrometer(Null, Null, 2540)
	...
	$iPt_From_MicroM = _LOImpress_ConvertFromMicrometer(Null, Null, Null, 2540)
	If @error Then _ERROR("Failed to convert to Micrometers from Millimeter. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)
