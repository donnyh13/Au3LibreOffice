...
Func Example()
	...
	; Retrieve the Cell Range Address
	$sAddress = _LOCalc_RangeGetAddressAsName($oCellRange)
	If @error Then _ERROR($oDoc, "Failed to retrieve Cell Range Address. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)

	MsgBox($MB_OK + $MB_TOPMOST, Default, "The Address for Cell Range A1 to C5 in Sheet 1 is: " & $sAddress)
