...
Func Example()
	...
	; Modify the Style Gradient settings to: Preset Gradient name = $LOI_GRAD_NAME_SUNDOWN
	_LOImpress_ShapePresStyleAreaGradient($oDoc, $oStyle, $LOI_GRAD_NAME_SUNDOWN)
	...
	$avStops = _LOImpress_ShapePresStyleAreaGradientMulticolor($oStyle)
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "The Style's Gradient ColorStops are as follows: " & @CRLF & _
			$sStops & @CRLF & @CRLF & _
	...
	_LOImpress_ShapePresStyleAreaGradientMulticolor($oStyle, $avStops)
