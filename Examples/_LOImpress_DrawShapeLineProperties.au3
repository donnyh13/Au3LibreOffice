...
Func Example()
	...
	_LOImpress_DrawShapeLineProperties($oShape, $LOI_DRAWSHAPE_LINE_STYLE_3_DASHES_3_DOTS, $LO_COLOR_MAGENTA, $iHMM, 50, $LOI_DRAWSHAPE_LINE_JOINT_BEVEL, $LOI_DRAWSHAPE_LINE_CAP_SQUARE)
