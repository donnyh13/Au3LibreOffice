...
Func Example()
	...
	$oControl = _LOWriter_FormConInsert($oForm, $LOW_FORM_CON_TYPE_TABLE_CONTROL, 500, 300, 6000, 2000, "AutoIt_Form_Control")
	...
	_LOWriter_FormConTableConGeneral($oControl, "Renamed_AutoIt_Control", Null, True, True, True, True, 1, $mFont, 1500, $LO_COLOR_GOLD, $LOW_FORM_CON_BORDER_FLAT, $LO_COLOR_INDIGO, True, True, "Some Additional Information", "This is Help Text", "www.HelpURL.fake")
	...
	$avControl = _LOWriter_FormConTableConGeneral($oControl)
