...
Func Example()
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "The Cell Style's current Font Effects settings are as follows: " & @CRLF & _
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "Now the Cell Style's current Font Effects settings are as follows: " & @CRLF & _
			"Relief style (See UDF Constants): " & $avSettings[0] & @CRLF & _
			"Are the words outlined? True/False: " & $avSettings[1] & @CRLF & _
			"Do the words have a shadow? True/False: " & $avSettings[2])
