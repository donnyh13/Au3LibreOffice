...
Func Example()
	...
	; Set Border Width (all four sides) to $LOC_BORDER_WIDTH_MEDIUM
	...
	; Set Page style Border Style settings to: Top = $LOC_BORDER_STYLE_DASH_DOT_DOT, Bottom = $LOC_BORDER_STYLE_THICKTHIN_MEDIUMGAP
	; Left = $LOC_BORDER_STYLE_DOUBLE, Right = $LOC_BORDER_STYLE_DASHED
	_LOCalc_PageStyleBorderStyle($oPageStyle, $LOC_BORDER_STYLE_DASH_DOT_DOT, $LOC_BORDER_STYLE_THICKTHIN_MEDIUMGAP, $LOC_BORDER_STYLE_DOUBLE, $LOC_BORDER_STYLE_DASHED)
	If @error Then _ERROR($oDoc, "Failed to modify Page Style settings. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)
