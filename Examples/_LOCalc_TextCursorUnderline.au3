...
Func Example()
	...
	; Set the underline settings to, Underline words only, Underline style $LOC_UNDERLINE_BOLD_DASH_DOT, and underline color = Gold.
	_LOCalc_TextCursorUnderline($oTextCursor, True, $LOC_UNDERLINE_BOLD_DASH_DOT, $LO_COLOR_GOLD)
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "The current Underline settings at the Cursor's current position are as follows: " & @CRLF & _
			...
			"The underline color is (as a RGB Color Integer): " & $avSettings[2])
