...
Func Example()
	...
	; Set Default Paragraph Style font Rotation to 90 degrees and scale to 75%.
	_LOWriter_ParStyleRotateScale($oParStyle, 90, 75)
	...
	$avParStyleSettings = _LOWriter_ParStyleRotateScale($oParStyle)
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "The Paragraph's current Rotation and scale settings are as follows: " & @CRLF & _
			"Current rotation in degrees: " & $avParStyleSettings[0] & @CRLF & _
			"Current scale width in percentage: " & $avParStyleSettings[1])
