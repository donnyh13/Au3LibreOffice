...
Func Example()
	...
	; Set Page style Shadow settings to: Location = $LOC_SHADOW_TOP_LEFT, Color = $LO_COLOR_RED, Width = 1/8"
	_LOCalc_PageStyleShadow($oPageStyle, $LOC_SHADOW_TOP_LEFT, $LO_COLOR_RED, $iHMM)
