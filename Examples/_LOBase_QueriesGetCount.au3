...
Func Example()
	...
	; Retrieve a count of Queries.
	$iCount = _LOBase_QueriesGetCount($oConnection)
	If @error Then Return _ERROR($oDoc, "Failed to retrieve a count of Queries in the Database. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "The document contains " & $iCount & " Query.")
