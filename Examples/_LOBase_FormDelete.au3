...
Func Example()
	...
	; Create another new form in the Folder.
	_LOBase_FormCreate($oConnection, "AutoIt_Folder/frmAutoIt_Form3", False)
	If @error Then Return _ERROR($oDoc, "Failed to create a form Document. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)
	...
	; Delete a form.
	_LOBase_FormDelete($oDoc, "frmAutoIt_Form")
	If @error Then Return _ERROR($oDoc, "Failed to delete a form. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)

	; Delete the form inside of the folder.
	_LOBase_FormDelete($oDoc, "AutoIt_Folder/frmAutoIt_Form2")
	If @error Then Return _ERROR($oDoc, "Failed to delete a form. Error:" & @error & " Extended:" & @extended & " On Line: " & @ScriptLineNumber)
