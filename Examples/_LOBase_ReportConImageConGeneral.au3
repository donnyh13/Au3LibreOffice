...
Func Example()
	...
	$oControl = _LOBase_ReportConInsert($oSection, $LOB_REP_CON_TYPE_IMAGE_CONTROL, 10500, 500, 4500, 2000)
	...
	$avControl = _LOBase_ReportConImageConGeneral($oControl)
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "The Control's current settings are: " & @CRLF & _
			...
			"Is the Image linked rather than embedded? True/False: " & $avControl[1] & @CRLF & _
