...
Func Example()
	...
	$avSettings = _LOWriter_DirFrmtCharUnderLine($oViewCursor)
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "The selected text's current underline settings are as follows: " & @CRLF & _
			...
			"Underline words only? True/False: " & $avSettings[2] & @CRLF & @CRLF & _
			"Press ok to remove direct formatting.")

	; Remove direct formatting
	_LOWriter_DirFrmtCharUnderLine($oViewCursor, Default, Default, Default)
