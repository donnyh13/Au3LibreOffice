...
Func Example()
	...
	MsgBox($MB_OK + $MB_TOPMOST, Default, "Press ok to delete the newly created Set Variable Master Field using its name.")

	; Delete the Set Var. MasterField using its name.
	_LOWriter_FieldSetVarMasterDeleteByName($oDoc, $sMasterFieldName)
